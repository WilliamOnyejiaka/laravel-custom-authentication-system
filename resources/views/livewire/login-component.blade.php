        ...
        <div class="section text-center">
            ...
            <div class="form-group">
                ...
                <i class="input-icon uil uil-at"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" class="bi bi-at" viewBox="0 0 16 16" style="color: black;">
                        <path
            ...
            <div class="form-group mt-2">
                <input type="password" name="loginPassword" class="form-style" placeholder="Your Password"
                    id="loginPassword" autocomplete="off">
                <i class="input-icon uil uil-lock-alt">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-lock-fill" viewBox="0 0 16 16" style="color: black;">
                        <path
